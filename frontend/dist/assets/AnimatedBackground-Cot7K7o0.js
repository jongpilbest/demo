...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:on,depthTest:!1,depthWrite:!1})}function Ua(){return new Gt({name:"EquirectangularToCubeUV",uniforms:{envMap:{value:null}},vertexShader:ar(),fragmentShader:`
		...
		`,blending:on,depthTest:!1,depthWrite:!1})}function Ia(){return new Gt({name:"CubemapToCubeUV",uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:ar(),fragmentShader:`
...
#define LOW_PRECISION`),e}const pd={[Zi]:"SHADOWMAP_TYPE_PCF",[mi]:"SHADOWMAP_TYPE_VSM"};function md(i){return pd[i.shadowMapType]||"SHADOWMAP_TYPE_BASIC"}const _d={[Fn]:"ENVMAP_TYPE_CUBE",[ti]:"ENVMAP_TYPE_CUBE",[rr]:"ENVMAP_TYPE_CUBE_UV"};function gd(i){return i.envMap===!1?"ENVMAP_TYPE_CUBE":_d[i.envMapMode]||"ENVMAP_TYPE_CUBE"}const xd={[ti]:"ENVMAP_MODE_REFRACTION"};function vd(i){return i.envMap===!1?"ENVMAP_MODE_REFLECTION":xd[i.envMapMode]||"ENVMAP_MODE_REFLECTION"}const Md={[Ja]:"ENVMAP_BLENDING_MULTIPLY",[cl]:"ENVMAP_BLENDING_MIX",[ul]:"ENVMAP_BLENDING_ADD"};function Sd(i){return i.envMap===!1?"ENVMAP_BLENDING_NONE":Md[i.combine]||"ENVMAP_BLENDING_NONE"}function Ed(i){const e=i.envMapCubeUVHeight;if(e===null)return null;const t=Math.log2(e)-2,n=1/e;return{texelWidth:1/(3*Math.max(Math.pow(2,t),112)),texelHeight:n,maxMip:t}}function Td(i,e,t,n){const r=i.getContext(),s=t.defines;let a=t.vertexShader,o=t.fragmentShader;const c=md(t),l=gd(t),f=vd(t),h=Sd(t),d=Ed(t),_=ad(t),v=od(s),M=r.createProgram();let m,u,b=t.glslVersion?"#version "+t.glslVersion+`
...
float alpha = edgeFade * 0.6 * atten;
      ...
      `}),c=new jt(new bi(r*2,r*2),o);n.add(c);function l(){const _=e.clientWidth,v=e.clientHeight,M=_/v;s.left=-M,s.right=M,s.top=1,s.bottom=-1,s.updateProjectionMatrix(),t.setSize(_,v),a.uRes.value.set(_,v)}l(),window.addEventListener("resize",l);const f=new rc;let h=0;const d=()=>{h=requestAnimationFrame(d),a.uTime.value=f.getElapsedTime(),t.render(n,s)};return d(),()=>{cancelAnimationFrame(h),window.removeEventListener("resize",l),n.remove(c),o.dispose(),t.dispose(),e.removeChild(t.domElement)}},[]),Go.jsx("div",{"code-path":"src\\components\\three\\AnimatedBackground.tsx:204:7",ref:i,className:"w-full h-[100%]"})}export{ip as default};
